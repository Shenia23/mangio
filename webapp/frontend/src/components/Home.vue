...
<template>
  <div >
       ...
       <div class="wrapper">
            ...
            <div class="section section-gray section-clients">
                <div class="container text-center">
                    ...
                    <p>
                        La decisión de usar cada una de estas tecnologías fue muy meditada con anterioridad.<br>
                    </p>
                    <div class="logos">
    ...
    <script src="../assets/js/jquery-1.10.2.js" type="application/javascript"></script>
    <script src="../assets/js/jquery-ui-1.10.4.custom.min.js" type="application/javascript"></script>
    <script  src="../assets/js/bootstrap.js" type="application/javascript"></script>
    <script src="../assets/js/awesome-landing-page.js" type="application/javascript"></script>
  </div>
</template>
