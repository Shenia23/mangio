...
sleep 10                      # Give the system time after a reboot to connect to WiFi before continuing
export MISCALE_MAC=5C:CA:D3:5B:EA:C6 # Mac address of your scale
...
export TIME_INTERVAL=3              # Time in sec between each query to the scale, to allow other applications to use the Bluetooth module. Defaults to 30
